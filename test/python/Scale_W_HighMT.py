if __name__ == "__main__":
    ...
    fDYS=ROOT.TFile("output_DatacardMaker/mt/ZTT.root","r")
    fDYJ=ROOT.TFile("output_DatacardMaker/mt/ZJ.root","r")
    fDYL=ROOT.TFile("output_DatacardMaker/mt/ZL.root","r")
    fW=ROOT.TFile("output_DatacardMaker/mt/Wunscaled.root","r")
    fTTJ=ROOT.TFile("output_DatacardMaker/mt/TTJ.root","r")
    fTTT=ROOT.TFile("output_DatacardMaker/mt/TTT.root","r")
    fVV=ROOT.TFile("output_DatacardMaker/mt/VV.root","r")
    fData=ROOT.TFile("output_DatacardMaker/mt/data_obs.root","r")
    fout=ROOT.TFile("output_DatacardMaker/mt/W.root","recreate")
    ...
    if (options.scale=="wdown"):
       fout=ROOT.TFile("output_DatacardMaker/mt/W_wdown.root","recreate")
    elif (options.scale=="wup"):
       fout=ROOT.TFile("output_DatacardMaker/mt/W_wup.root","recreate")
    elif (options.scale=="qcddown"):
       fout=ROOT.TFile("output_DatacardMaker/mt/W_qcddown.root","recreate")
    elif (options.scale=="qcdup"):
       fout=ROOT.TFile("output_DatacardMaker/mt/W_qcdup.root","recreate")
