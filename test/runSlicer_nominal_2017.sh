...
if [ $ztt = "true" ]; then
    ...
    ./slicer_${channel}_2017.exe ${input}/DY0_1.root output_Slicer/${channel}/ZTT/ZTT0_1.root DY0 ZTT nominal 
    ./slicer_${channel}_2017.exe ${input}/DY0_2.root output_Slicer/${channel}/ZTT/ZTT0_2.root DY0 ZTT nominal
...
if [ $w = "true" ]; then
    ...
    ./slicer_${channel}_2017.exe ${input}/W0_1.root output_Slicer/${channel}/W/W0_1.root WJets0 W nominal
    ./slicer_${channel}_2017.exe ${input}/W0_2.root output_Slicer/${channel}/W/W0_2.root WJets0 W nominal
...
if [ $diboson = "true" ]; then
    ...
    ./slicer_${channel}_2017.exe ${input}/WW1l1nu2q_powheg_1.root output_Slicer/${channel}/VVT/WW1l1nu2q_powheg_1.root WW1L1Nu2Q VVT nominal
    ./slicer_${channel}_2017.exe ${input}/WW1l1nu2q_powheg_2.root output_Slicer/${channel}/VVT/WW1l1nu2q_powheg_2.root WW1L1Nu2Q VVT nominal
    ...
    ./slicer_${channel}_2017.exe ${input}/ZZ4l_1.root output_Slicer/${channel}/VVT/ZZ4l_1.root ZZ4L VVT nominal
    ./slicer_${channel}_2017.exe ${input}/ZZ4l_2.root output_Slicer/${channel}/VVT/ZZ4l_2.root ZZ4L VVT nominal
    ...
    ./slicer_${channel}_2017.exe ${input}/WW1l1nu2q_powheg_1.root output_Slicer/${channel}/VVJ/WW1l1nu2q_powheg_1.root WW1L1Nu2Q VVJ nominal
    ./slicer_${channel}_2017.exe ${input}/WW1l1nu2q_powheg_2.root output_Slicer/${channel}/VVJ/WW1l1nu2q_powheg_2.root WW1L1Nu2Q VVJ nominal
    ...
    ./slicer_${channel}_2017.exe ${input}/ZZ4l_1.root output_Slicer/${channel}/VVJ/ZZ4l_1.root ZZ4L VVJ nominal
    ./slicer_${channel}_2017.exe ${input}/ZZ4l_2.root output_Slicer/${channel}/VVJ/ZZ4l_2.root ZZ4L VVJ nominal
...
if [ $signal = "true" ]; then
    ...
    ./slicer_${channel}_2017.exe ${input}/ggHtoTauTau125_1.root output_Slicer/${channel}/ggH125_1.root ggH125 ggH125 nominal
    ./slicer_${channel}_2017.exe ${input}/ggHtoTauTau125_2.root output_Slicer/${channel}/ggH125_2.root ggH125 ggH125 nominal
    hadd -f output_Slicer/${channel}/ggH125.root output_Slicer/${channel}/ggH125_1.root output_Slicer/${channel}/ggH125_2.root
